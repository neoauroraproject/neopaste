/** Small Lucide-style SVG icons (24 viewBox). No emojis. */
...
export function icon(name, className = 'ico') {
  const paths = {
    ...
    flame: 'M17.657 18.657A8 8 0 0 1 6.343 7.343S7 9 9 10c0-2 1.5-5.5 3.5-6.5C14 6 16.5 8 16.5 11c1.5-1 2.5-1.5 2.5-1.5a8.001 8.001 0 0 1-1.343 9.157z',
...
export function iconLabel(name, text, className = 'ico-label') {
  return el('span', { className }, [icon(name), el('span', { text })])
}
